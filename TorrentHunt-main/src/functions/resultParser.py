...
def result(response, userLanguage, resultType, torrentType, page, category=None, week=None, query=None, originalQuery=None):
    ...
    if query:
        ...
        markup.add(telebot.types.InlineKeyboardButton(text='Nyaa', switch_inline_query_current_chat=f"!nyaa {query}"), telebot.types.InlineKeyboardButton(text='YourBT', switch_inline_query_current_chat=f"!ybt {query}"), telebot.types.InlineKeyboardButton(text='Tor Lock', switch_inline_query_current_chat=f"!tl {query}"))
        ...
        if msg:
            markup.add(telebot.types.InlineKeyboardButton(text='🌟 Rate ', url='https://t.me/tlgrmcbot?start=Utorrent_searcherbot-review'), telebot.types.InlineKeyboardButton(text=language['donateBtn'][userLanguage], url='https://buymeacoffee.com/hemantapkh'))
